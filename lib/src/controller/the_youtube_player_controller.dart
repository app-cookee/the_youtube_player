...
import 'the_youtube_player_event_handler.dart';
...
///
/// The video is displayed in a Flutter app by creating a [TheYoutubePlayer] widget.
///
/// After [TheYoutubePlayerController.close] all further calls are ignored.
class TheYoutubePlayerController implements YoutubePlayerIFrameAPI {
  ...
  TheYoutubePlayerController({
    ...
    _eventHandler = TheYoutubePlayerEventHandler(this);
  ...
  /// Creates a [TheYoutubePlayerController] and initializes the player with [videoId].
  factory TheYoutubePlayerController.fromVideoId({
    ...
    final controller = TheYoutubePlayerController(params: params);
  ...
  late final TheYoutubePlayerEventHandler _eventHandler;
  ...
  /// Listen to updates in [TheYoutubePlayerController].
  ...
  /// Disposes the resources created by [TheYoutubePlayerController].
