...
class TheYoutubePlayerEventHandler {
  /// Creates [TheYoutubePlayerEventHandler] with the provided [controller].
  TheYoutubePlayerEventHandler(this.controller) {
    _events = {
      'Ready': onReady,
  ...
  /// For example, if you call the [TheYoutubePlayerController.setPlaybackRate] function,
  ...
  /// that the playback rate will automatically change when the [TheYoutubePlayerController.setPlaybackRate] function is called.
  ///
  /// Similarly, your code should not assume that the video playback rate will only change
  /// as a result of an explicit call to [TheYoutubePlayerController.setPlaybackRate].
