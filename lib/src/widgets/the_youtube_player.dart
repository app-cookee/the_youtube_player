...
import 'package:the_youtube_player/src/widgets/the_fullscreen_youtube_player.dart';
...
/// See also:
///
///  * [TheFullscreenYoutubePlayer], which play or stream Youtube Videos in fullscreen mode.
  ...
  Widget build(BuildContext context) {
    ...
    return OrientationBuilder(
      builder: (context, orientation) {
        return AspectRatio(
          aspectRatio: orientation == Orientation.landscape ? MediaQuery.of(context).size.aspectRatio : widget.aspectRatio,
          child: player,
        );
      },
    );
