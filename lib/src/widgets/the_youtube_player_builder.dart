...
/// A widget the scaffolds the [TheYoutubePlayer] so that it can be moved around easily in the view
/// and handles the fullscreen functionality.
class TheYoutubePlayerBuilder extends StatefulWidget {
  /// Creates [TheYoutubePlayerBuilder].
  ...
  @override
  State<TheYoutubePlayerBuilder> createState() => _TheYoutubePlayerBuilderState();
}

class _TheYoutubePlayerBuilderState extends State<TheYoutubePlayerBuilder> {
